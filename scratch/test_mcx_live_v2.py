...
def test_mcx_fetch():
    ...
    try:
        # Test with "1minute" as the interval string (V2 style)
        print(f"Fetching intraday candles for {spot_key} with interval '1minute'...")
        resp = history_api.get_intra_day_candle_data(spot_key, "1minute")
